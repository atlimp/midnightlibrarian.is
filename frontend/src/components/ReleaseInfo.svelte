...
<div class="flex flex-col gap-8 md:gap-0 md:grid place-items-center md:grid-cols-[fit-content(33%)_minmax(0,_1fr)_minmax(0,_1fr)] md:grid-rows-[minmax(0,_1fr)_minmax(0,_1fr)_70px] h-fit xl:px-8">
    <img src={release.image} alt="Art" class="h-48 w-48 md:h-60 md:w-60 xl:h-80 xl:w-80 m-auto border-2 border-black border-solid rounded-lg md:row-span-3 mx-4 xl:mx-8" />
